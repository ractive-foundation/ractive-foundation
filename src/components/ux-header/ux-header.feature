Feature: ux-header
  ...
  Scenario: Loading ux-header level 1
    ...
    Then the element "h1" should have the "class" of "h1Class"
  ...
  Scenario: Loading ux-header level 2
    ...
    Then the element "h2" should have the "class" of "h2Class"
  ...
  Scenario: Loading ux-header level 3
    ...
    Then the element "h3" should have the "class" of "h3Class"
  ...
  Scenario: Loading ux-header level 4
    ...
    Then the element "h4" should have the "class" of "h4Class"
  ...
  Scenario: Loading ux-header level 5
    ...
    Then the element "h5" should have the "class" of "h5Class"
  ...
  Scenario: Loading ux-header level 6
    ...
    Then the element "h6" should have the "class" of "h6Class"
